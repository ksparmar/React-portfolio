        ...
        <section id ="about">
            <div className = "container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                <div className = "lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p className ="bm-8 text-white leading-relaxed">
                    I am a 4th year computing science student at Simon Fraser University. 
                    I love building apps, websites and playing around with data.
                    </p>
                    <div className = "flex justify-center">
                        ...
                        <a href ="#projects"
                        className = "ml-4 inline-flex text-white bg-gray-800 border-0 mt-6 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg">
                        See my past work!    
                        </a>
                    </div>
                </div>
